...
<!-- HTML part with Background Image Applied to Wrapper -->
<div class="wrapper" style="background-image: url('Expense Tracker\static\images\bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    <div class="row">
